...
export class FlaskapiService {
  ...
  public server:string = "http://localhost:8000/api/";
  ...
  public getPost(postId : string){
    return this.httpClient.get<any>(this.server + "post/" + postId)
  }
  ...
  public editPost(postObj: Post, image: any){
    ...
    formData.append("title", title);
    formData.append("content", content);
    formData.append("oldcover", oldcover? oldcover :"");
    formData.append("covername", covername ? covername : "");
